...
export class Song {
  ...
  */
  ...
  constructor(private name: string, private autor: Artist, private duration: number, private genres: genreInfo[], private single: boolean, private reproductions: number, private listener: number) {
    this.autor = autor;
